 ...
 * Take a look at Java�s `split method, that splits a ``String``into an array containing the parts split by the specified regular expression.Here, assume the regular expression is simply " ", so that the input String is split into words.
...
public class StringMethods {
	...
	public static String selfConcat(String s) {
		return concaString(s, 0);
	}
	public static String concaString(String s, int n){
		return s+n; 
	}
